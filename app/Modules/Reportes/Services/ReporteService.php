...
class ReporteService
{
     ...
     * @return array{columnas: list<string>, filas: list<array<int, string|int|float>>}
     */
    public function academico(?string $desde, ?string $hasta): array
    {
        $calificaciones = Calificacion::query()
            ->with(['estudiante', 'evaluacion.horario.grado', 'evaluacion.horario.curso'])
            ->whereHas('evaluacion', function ($query) use ($desde, $hasta) {
     ...
     * @return array{columnas: list<string>, filas: list<array<int, string|int|float>>}
     */
    public function operativo(?string $desde, ?string $hasta): array
    {
     ...
     * @return array{columnas: list<string>, filas: list<array<int, string|int|float>>}
     */
    public function propio(User $docente, ?string $desde, ?string $hasta): array
    {

<section id="inicio" class="relative overflow-hidden bg-[#0a0a0a] pt-16 sm:pt-20">
    <div class="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(220,38,38,0.12),transparent_45%),radial-gradient(circle_at_80%_0%,rgba(15,27,61,0.6),transparent_40%)]"></div>

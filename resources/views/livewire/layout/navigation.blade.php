        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-2">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-ink-dim bg-surface hover:text-ink focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="-me-2 flex items-center gap-1 sm:hidden">
                ...
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-ink-faint hover:text-ink hover:bg-surface-2 focus:outline-none focus:bg-surface-2 transition duration-150 ease-in-out">

...
<div {{ $attributes->merge(['class' => "rounded-2xl border border-white/5 bg-[#1a1a1c] {$relleno}"]) }}>
    <div @class(['flex shrink-0 items-center justify-center rounded-full', $tamanoIcono, $tono])>
